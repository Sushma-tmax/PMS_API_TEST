...
import { useEditObjectiveTypeMutation } from "../../../service/Objective/ObjectoveType";
...
const ObjectiveType1 = (props: any) => {
  ...
  const [editObjectiveType] = useEditObjectiveTypeMutation()
  const [disableObjectiveGroupSelect, setDisableObjectiveGroupSelect] = useState(false)
  ...
  const handleMenuEdit = (
    ...
    editObjectiveType({
      ...
      if (res.data?.success && res?.data?.template?.status_template === "Completed") {       
        setDisableObjectiveGroupSelect(true)
      }   else {
        setDisableObjectiveGroupSelect(false)  
      }    
    })
  };
                  ...
                  <Stack direction="column">
                    ...
                    >
                      ...
                      MenuProps={MenuProps}
                        ...
                        disabled = {disableObjectiveGroupSelect}
...
background:"transparent",
      ...
      <Snackbar
        ...
        onClose={handleClickobjTypeClose}
      ...
      >
       ...
       <Snackbar
        ...
        open={openobjTypedel}
        autoHideDuration={3000}
        onClose={handleClickobjTypedelClose}
        anchorOrigin={{ vertical: 'bottom', horizontal: 'right' }}
      >
        <Alert
          className={classes.customAlert}
          ...
          icon={false}
        >
          <b>{name} has been deleted successfully.</b>
        </Alert>
      </Snackbar> 
      {/* <AlertDialogSuccess
