      ...
      mapObjectiveGroupData()
        ...
        .map((row: any, index: number) => {
          ...
          return {
            ...
            ["Objective Group"]: row?.ObjectiveGroup,

            ["Objective Type"]: row?.ObjectiveType,

            ["Objective Title"]: row?.ObjectiveTitle,

            ["Definition"]: row.ObjectiveDescription,

            ["Objective Level"]: row.Levels && objLevel
        ...
        >
          ...
          <div >
            ...
            <Table size="small" aria-label="simple table">
              <TableHead
                sx={{
                  bgcolor: "#eaeced",position: "sticky", zIndex: "1000", top: "0px"
                }}
              >
                <TableRow
                  sx={{
