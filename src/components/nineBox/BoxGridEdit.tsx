...
import AlertOkCancel from "../UI/DialogOkCancel";
...
export default function BoxGrid(props: any) {
  ...
  return (
    <>
      <PAMaster
        name={"Edit 9-Box Grid"}
        nav={`${BOX_GRID}`}
        secondName={"9-Box Grid"}
      />
      <Box
        sx={{
      ...
      >
                                ...
                                <TextField
                                  ...
                                  onChange={(e) => {                                 
                                    ...
                                    if (regex.test(inputValue)) {                               
                                      setPerformanceDefinitionHighFrom(inputValue);
                                      setnavPrompt(true);
                                    }                                   
                                    }}
                                />
                              ...
                              <Text>
                                <TextField
                                  ...
                                  onChange={(e) => {                                 
                                    ...
                                    const regex = /^(10(\.0{0,2})?|[1-9](\.\d{0,2})?)?$/;                                                      
                                    if (regex.test(inputValue)) {                               
                                      setPerformanceDefinitionHighTo(inputValue);
                                      setnavPrompt(true);
                                    }                                   
                                    }}
                                />
                              ...
                              <Text>
                                <TextField
                                  ...
                                  onChange={(e) => {                                 
                                    ...
                                    const regex = /^(10(\.0{0,2})?|[1-9](\.\d{0,2})?)?$/;                                                       
                                    if (regex.test(inputValue)) {                               
                                      setPerformanceDefinitionMediumFrom(inputValue);
                                      setnavPrompt(true);
                                    }                                   
                                    }}
                                />
                              ...
                              <Text>
                                <TextField
                                  ...
                                  onChange={(e) => {                                 
                                    ...
                                    const regex = /^(10(\.0{0,2})?|[1-9](\.\d{0,2})?)?$/;                                                      
                                    if (regex.test(inputValue)) {                               
                                      setPerformanceDefinitionMediumTo(inputValue);
                                      setnavPrompt(true);
                                    }                                   
                                    }}
                                />
                            ...
                            >
                              <Text>
                                <TextField
                                  ...
                                  // onChange={(e) => {
                                  //   const newValue = e.target.value.slice(0, 4);
                                  //   setPerformanceDefinitionLowFrom(newValue);
                                  //   // setPerformanceDefinitionLowFrom(
                                  //   //   e.target.value
                                  //   // );
                                  //   setnavPrompt(true);
                                  ...
                                  const regex = /^(10(\.0{0,2})?|[1-9](\.\d{0,2})?)?$/;                                                      
                                  if (regex.test(inputValue)) {                               
                                    setPerformanceDefinitionLowFrom(inputValue);
                                    setnavPrompt(true);
                                  }                                   
                                  }}
                                />
                              ...
                              <Text>
                                <TextField
                                  ...
                                  onChange={(e) => {                                 
                                    ...
                                    const regex = /^(10(\.0{0,2})?|[1-9](\.\d{0,2})?)?$/;                                                       
                                    if (regex.test(inputValue)) {                               
                                      setPerformanceDefinitionLowTo(inputValue);
                                      setnavPrompt(true);
                                    }                                   
                                    }}
                                />
        ...
        <AlertOkCancel
          ...
          handleAlertIdClose={handleAlertDialogYes}
          handleAlertClose={handleAlertDialogNo}
        >
          Any changes you have made will not be saved if you leave the page.
        </AlertOkCancel>
      </Box>
