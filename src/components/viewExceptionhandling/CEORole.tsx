...
import { useGetEmployeeQuery,useGetEmployeeByFilterQuery,
  ...
  useRemovesMultipleEmployeeFromRoleExceptionMutation } from "../../service";
...
export default function CEORole(props:any) {
  ...
  appraiser_name,section,normalizer_name,reviewer_name,isGradeException,isCEORole,probation_status,first_name,
...
employeeUpdate({
    ...
    setLaunchValDialogMSG("Employee has been removed from CEO Role")
});
}
...
const handleMultiDelete = () =>{
  ...
  if(data?.length > 0){
    removeFromRoleexception({
      ...
      res.error ? <> </> : 
      setLaunchValDialog(true);
      setLaunchValDialogMSG("The selected employees were removed from CEO Role")
  });
  }else{
    setLaunchValDialog(true);
