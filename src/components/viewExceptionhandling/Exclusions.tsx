...
export default function Exclusions(props:any) {
  ...
  appraiser_name,normalizer_name,section,reviewer_name,isExcluded,probation_status,first_name,
  isSupervisor,section,isSelected,sub section,overall_rating,division,manager_position,work_location,appraiser_code,reviewer_code,normalizer_code`
