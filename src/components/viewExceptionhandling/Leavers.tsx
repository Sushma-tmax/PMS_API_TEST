...
export default function Leavers(props:any) {
  ...
  const {values , employeeList} = props;
  ...
  appraiser_name,normalizer_name,section,reviewer_name,isLeavers,probation_status,first_name,
...
employeeUpdate({
    ...
    setLaunchValDialogMSG("Employee has been removed from Leavers")
});
}
