...
import Teamreview from "../../homepage/MyTeamDashboardComponents/MyTeamTable/Reviewer/TeamTableReviewermain";
import Teamreviewcopy1 from "../../homepage/MyTeamDashboardComponents/MyTeamTable/Reviewer/TeamTableUIReviewer";
...
export default function ViewPreviouspa(props: any) {
  return (
    <>
      <Box
        sx={{
