...
export default function AppraiserViewPA(props: any) {
  ...
  useEffect(() => {
    if (employeeData?.data?.employee_previous_submission?.area_of_improvement) {
      ...
      if (employeeData?.data?.employee_previous_submission?.area_of_improvement == '' || employeeData?.data?.employee_previous_submission?.area_of_improvement == undefined) {
        setspecificAction1(false);
      } else {
        setspecificAction1(true);
      }
  ...
  //   const tolerance = 0.1;
  //   const FilteredRatingScale = RatinGscale?.filter((item: any) => {
  //     // console.log("Matched condition 1 for rating: ", item.rating);
  ...
  //       }
  //     }
  //     //  else if (Math.abs(item.rating - Overall_rating) <= tolerance)
  ...
  //   console.log("FilteredRatingScale: ", FilteredRatingScale);
  // }, [ratingScaleData, employeeData])
  ...
  console.log(employeeData?.data?.appraisal?.other_recommendation.length, employeeData?.data?.appraisal?.other_recommendation_others,
    "length")
  useEffect(() => {
    if (employeeData && employeeData.data) {
        ...
        >
          <Breadcrumbs aria-label="breadcrumb">
            <Link
              ...
              color="inherit" to={`/dashboardreview`}
              state={{
                  ...
                  <label style={{
                    ...
                    <div>
                      ...
                      >
                        ...
                        >
                          {/* <b>
                            {(employeeData?.data?.appraisal?.appraiser_status == "draft") ?
