...
import TeamApprove from './ReviewerRating';
import Performancefeedbacksummary1 from './AppraiserFeedbackQuestionnaire';
import Table21 from './AppraiserTrainingRecommendation';
import AppraiserOtherRecommendations1 from './AppraiserFurtherRecommendations';
...
import FooterButtonsRecommendation from './OverallTab__FooterButtons';
...
const ReviewerApprove = (props: any) => {
...
export default ReviewerApprove;