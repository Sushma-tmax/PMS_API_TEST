...
const ReviewerRejectsAppraiser = (props: any) => {
  ...
  const { employeeData, trainingData, ratingData, otherData,refetch,fetchCancel } = props;
...
export default ReviewerRejectsAppraiser;
