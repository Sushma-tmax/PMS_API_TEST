...
import Teamreview from "../../../homepage/MyTeamDashboardComponents/MyTeamTable/Appraiser/TeamTableAppraisermain";
import Teamreviewcopy from "../../../homepage/MyTeamDashboardComponents/MyTeamTable/Appraiser/TeamTableUIAppraiser";
...
export default function ViewPastpa(props: any) {
  return (
    <>
      <Box
        sx={{
