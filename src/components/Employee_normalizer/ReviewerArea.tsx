...
const ReviewerArea = (props: any) => {
    // @ts-ignore
    const { reviewerAreaOfImprovement, setReviewerAreaOfImprovement } = useNormalizerContext()
    const [filterData, setFilterData] = useState([])

console.log( reviewerAreaOfImprovement,'llll')
    ...
    useEffect(() => {
        const group = _.groupBy(reviewerAreaOfImprovement, 'value')
                    ...
                    <table   >
                        <thead >
                            <tr>
                                ...
                                <th style={{ fontWeight: '400', fontSize: '12px', color: '#707070', opacity: 0.8 }} ><Pad1>Areas for Improvement</Pad1></th>
