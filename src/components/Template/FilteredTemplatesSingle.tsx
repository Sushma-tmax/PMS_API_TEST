...
import FilteredpositionsSingle from "./FilteredpositionsSingle";
//prompt -------functions
...
const FilteredTemplatesSingle = (props: any) => {
  const { loading } = props;
...
console.log(calendarData,'calendarData')
  ...
  useEffect(() => {
    if (id) {
      const result1 = calendarData?.data?.filter((item: any) => {
        console.log(item?._id,id, "itemsss");
        // return item?._id == id;
      });
      console.log(result1,'result1')
      const result = appraisalCalendarData?.data?.filter((item: any) => {
        console.log(item?.calendar, "itemsss");
        return item?.calendar?._id == result1;
      });   
      ...
      >
        ...
        <Grid container style={{ paddingTop: "16px" }} spacing={2}>
          <Grid item xs={2.5} sx={{ marginTop: "10px" }}>
            ...
            <Paper sx={{ paddingTop: "10px", width: 250, height: "calc(100vh - 260px)" }}>
              <div
                style={{
                  paddingLeft: "20px",
                  // paddingRight: "20px",
...
export default FilteredTemplatesSingle;
