...
const EmployeeRejectionofclosedcalendarDashboard = (props: any) => {
  const { completedCount, inprogressCount, inMediaton, range1, range2, 
    range3, range4,TotalEmp,CompletedEmp,valueOfActiveCalender,linkofAppraiser,setselectedRatingRange,setRatingsExpandActive,appCalId,
    checkAppraisalStatusCompleted,checkAppraisalStatusInmediation,checkAppraisalStatusRenormalization,checklengthinRangesL
    ,checklengthinRangesA,checklengthinRangesG,checklengthinRangesH,navigationRole} = props;
    console.log(TotalEmp,CompletedEmp,linkofAppraiser,checkAppraisalStatusRenormalization,"linkofAppraiser")
...
export default EmployeeRejectionofclosedcalendarDashboard;
