...
export default function TopPerformersExpandofNorOverallDashboard(props: any) {
  ...
  const topPerformerEmployees = (): any[] => {
    return FinalData
      .slice()
      .sort(
        (a: any, b: any) =>
  ...
  .map((i: any) => {
    ...
    console.log(grades,"gradesgrades")
  ...
  },[topPerformerEmployeeso,positionsFilter,enteredName,GradesFilter])
