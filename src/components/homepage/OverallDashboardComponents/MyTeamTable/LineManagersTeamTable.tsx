...
const LineManagersTeamTable = (props: any) => {
  ...
  const { startAppraisal, employeeData1,setPage,page, SectionFilter, setSectionFilter, subSectionFilter,
    setSubSectionFilter, valueOfCard, setTeamtableExpandActive, Role, Rolee } = props;
  ...
  useEffect(() => {
    ...
    // }
    console.log(mapped, "mapped")
  }, [users, empEmployeeCode, sectionsFilter, positionsFilter, GradesFilter, empFullName, empgrades, positions, enteredName, tabValue])
  ...
  }, [tabValue, activeTemplate, GradeFilter, positionsFilter, GradesFilter, enteredName])
  useEffect(() => {
          ...
          <Stack direction="row" alignItems="flex-start" >
            ...
            {Role != "Reviewer" && (
              ...
              <img
                ...
                onClick={() => {
                  navigate('/overalldashboardexpandtable', { state: { Role: Rolee, tabValue: tabValue } })
                }}
              />
            )}
            {/* </Link> */}
                            ...
                            {tabValue == 4 && (
                               <TableCell align="center" style={{
                                ...
                                color: (j?.appraisal?.status == "rejected" ||  j.employee.employee_status === "rejected") ? "red" : "#333333",                        // color: j?.employee?.objective_description?.filter((item : any) => item?.rating_rejected)?.length === 0 ?
                                 ...
                                 {(j?.employee?.employee_rating == 0 || j?.employee?.employee_status == "draft") ? (
                                    <span> - </span>
                                  ) : (
