...
export default function FilteredTableofExpNineboxRevieweroverall(props: any) {
  ...
  appraisal.objective_description,overall_rating,reviewerIsDisabled,pa_status,employee.employee_rating`
