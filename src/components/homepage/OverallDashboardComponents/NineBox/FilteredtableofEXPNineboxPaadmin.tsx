...
export default function FilteredtableofEXPNineboxPaadmin(props: any) {
  ...
  console.log(employeeData1, "idss")
  ...
  const { data: data2 } = useGetEmployeeByFilterQuery(`?select=appraisal.status,first_name,employee.employee_agree,section,sub_section,employee.employee_status&manager_code=${user?.employee_code}&calendar=${appCalId}&limit=800`)
  //Appraiser
