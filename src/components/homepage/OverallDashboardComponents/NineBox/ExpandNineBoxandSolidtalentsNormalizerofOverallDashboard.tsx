...
export default function ExpandNineBoxandSolidtalentsNormalizerofOverallDashboard(props: any) {
...
//console.log(moderate_3?.data[0]?.legal_full_name,moderate_4,moderate_5,"moderate_4")
  ...
  const handleNavigationForNineBoxEmployee = (name:any) => {
    navigate("/filteredTableofNormalizerExpNineBox",{ state: {selectName :name}}) 
  }
  return (
    <>
    <Stack
