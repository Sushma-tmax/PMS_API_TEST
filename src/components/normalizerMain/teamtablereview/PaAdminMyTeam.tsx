...
const PaAdminMyTeam = (props: any) => {
  ...
  const { startAppraisal, employeeData, statusSort, SectionFilter, setSectionFilter,
    subSectionFilter, setSubSectionFilter, divisionFilter, valueOfCard } = props;
  ...
  return (
    <Mytable>
      ...
      >
        <Tabstyles>
        <Box  sx={{  maxWidth: { xs: 530, md: 730 ,lg:1000}}}>
