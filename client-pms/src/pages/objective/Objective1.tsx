...
import ObjectiveTitle from "../../components/objectiveSettings/ObjectiveTitle";
import ObjectiveGroup1 from "../../components/objectiveSettings/ObjectiveGroup1";
import ObjectiveType1 from "../../components/objectiveSettings/ObjectiveType1";
...
import NewObjectiveDescription from "../../components/objectiveSettings/ObjectiveLevels";
import ObjectiveLevels from "../../components/objectiveSettings/ObjectiveLevels";
...
const handleClickobjTitledelClose = () => {
  ...
  const [deleteDescTitle, { isError: delTitleError }] =
    useDeleteObjectiveDescriptionMutation();
  ...
  return (
    <>
      <div style={{ background: "#F1F1F1", height: "41rem" }}>
        ...
        >
              ...
              <Dialog
                ...
                >
                  ...
                  {delTitle && (
                    <div >
                      {" "}
                      The Objective Title is used in performance appraisal and cannot be deleted.
                    </div>
                  )}
          ...
          <Grid>
            <Grid container>
              <Grid item xs={4} paddingLeft="0px" paddingRight="10px">
                <ObjectiveGroup1
                  ObjectiveGroupData={ObjectiveGroupData}
                  loading={ObjectiveGroupLoading}
                  onSubmit={objectiveGroupClickHandler}
              ...
              <Grid item xs={4} paddingLeft="10px" paddingRight="0px">
                <ObjectiveTitle
                  objectiveDescriptionData={objectiveDescriptionData}
                  objectiveTypeData={objectiveType}
