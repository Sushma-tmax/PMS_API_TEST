...
import NormalizerOtherCommentsN from './previousFiles/NormalizerOtherCommentsN';
import NormalizerRatingN from './NormalizerRating';
import NtrainingCommentsN from './previousFiles/NtrainingCommentsN';
...
const NormalizerApprove = (props: any) => {
  ...
  const { trainingData, ratingData, otherData, employeeData, nineBoxData, ratingScaleData } = props
                  ...
                  <div>
                    ...
                    <Footer>
                      {/* <ProvidedAppraisalContextProvider> */}
                        <FooterButtonsN
                          value={value} setValue={setValue} handleChange={handleChange}
