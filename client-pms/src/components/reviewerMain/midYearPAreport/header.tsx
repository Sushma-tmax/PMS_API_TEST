                    ...
                    <>
                        <Box sx={{ flexGrow: 1 }}>
                            <Grid container spacing={2}>
                                ...
                                <Grid item xs>
                                    <Item>
                                        <p>{headerData.data.employeeCode} </p>
                                        <p
                                            style={{
                                                color: "#014D76",
                                            }}
                            ...
                            <Grid container spacing={0}>
                                ...
                                <Grid item xs={4}>
                                    <Item sx={{ backgroundColor: "#f2f9fa", textAlign: "left" }}>
                                        <p>{headerData.data.name}</p>
                                        <p>{headerData.data.section} * {headerData.data.position}</p>
                                    </Item>
                                </Grid>
                                <Grid item xs={5}>
                                ...
                                >
                                    <Item sx={{ backgroundColor: "#f2f9fa" }}>
                                        <div style={{ borderLeft: "3px solid #e4ebef" }}>
                                            <h2>{headerData.data.appraisal.appraiser_rating}</h2>
                                            <p>Exceeding</p>
                                        </div>
                                    </Item>
                                </Grid>
