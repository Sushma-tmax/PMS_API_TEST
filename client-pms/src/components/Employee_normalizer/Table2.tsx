...
const Table2 = () => {
    ...
    //@ts-ignore
    const {appraiserTrainingRecommendation, setAppraiserTrainingRecommendation, trainingSelectValue, trainingRecommendationFormValues, setTrainingRecommendationFormValues} = useNormalizerContext()

    console.log(appraiserTrainingRecommendation, 'trainingRecommendation')

    return (
        <div><Typo1>Appraiser  Training Recommendation(s) </Typo1>
