...
> = (props: IRatingScaleDescriptionViewListProps) => {
  const { ratingScaleData, onDelete, onUpdate, error,openDelSuccess,handleDelSuccessClose } = props;
        ...
        >
         <div >
            ...
            {hideAlert && error && (
              ...
              <div >This rating is used in the performance appraisal and cannot be deleted.</div>
            )}
          </div>
