...
import { Container, Box, FormControlLabel, MenuItem, IconButton, FormControl, Dialog, DialogContent, DialogContentText, DialogActions, Alert } from "@mui/material";
...
export default function ExpandedTeamTableofReviewer(props: any) {
  ...
  reviewerIsDisabled,,normalizerIsChecked,normalizerIsDisabled,first_name,service_reference_date,position_code,division,section,sub section,manager_code,manager_name,manager_position,work_location,grade_set,job_code,job_level,job_title`
