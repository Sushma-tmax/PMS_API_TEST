...
import Attachicon from "../ReviewerRejection/Icons/Attachicon.svg";
import Right1 from "../Reviewericons/Right.svg";
import Greyplus from "../ReviewerRejection/Icons/Greyplus.svg";
import Minus from "../ReviewerRejection/Icons/Minus.svg";
...
const Accordion01 = (props: any) => {
  // @ts-ignore
  const { ratingData, empData } = useAppraiserRejectsReviewerContext();
        ...
        <Cont>
          ...
          >
            <>
              ...
              >
                <H1>{objective.objective_title.objective_title}</H1>
