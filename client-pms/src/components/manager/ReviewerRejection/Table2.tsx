...
const Table2 = () => {
  ...
  //@ts-ignore
  const { appraiserTrainingRecommendation, appraiserTrainingRecommendationComments, trainingSelectValue, trainingRecommendationFormValues, setTrainingRecommendationFormValues } = useAppraiserRejectsReviewerContext()
  ...
  return (
    <div>
      ...
      >
        <Typo1>Reviewer  Training Recommendation(s) </Typo1>
        ...
        <Root sx={{ width: "99%" }}   >
          <table   >
            <thead>
              <tr>
                ...
                <th style={{ fontWeight: '400', fontSize: '12px', color: '#707070', opacity: 0.8 }} ><Pad1>Reviewer Comments</Pad1></th>
              </tr>
            </thead>
            <tbody>
          ...
          <Box sx={{ paddingTop:"13px" }}>
            <TextField
              ...
              value={appraiserTrainingRecommendationComments}
            />
          </Box>
        </Root>
      </Tablecontainer>
