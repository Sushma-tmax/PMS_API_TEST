...
const MyAccordion = (props: any) => {
  ...
  useEffect(() => {
    const checkData = dateList.map((j: any) => {
      ...
      if (isAfter(parseISO(j.start_date), parseISO(j.end_date))) {
        setErrorMessage("Calendar start date should be a date before calendar end date. ");
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Reviewer Start Date should be a date before Reviewer End Date. "
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Appraiser Start Date should be a date before Appraiser End Date. "
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Normalizer Start Date should be a date before Normalizer End Date. "
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "F2F Meeting Start Date should be a date before F2F Meeting End Date. "
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Employee Acknowledgement Start Date should be a date before Employee Acknowledgement End Date."
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Mediation Start Date should be a date before Mediation End Date. "
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Re_Normalization Start Date should be a date before Re_Normalization End Date."
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Closing Start Date should be a date before Closing End Date."
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "PA Closing End Date should be same as Calendar End Date."
        );
        setOpen2(true);
        status = true;
      }
      if (
        ...
        setErrorMessage(
          "Appraiser Start Date should be a date after Calendar Start Date. "
        );
        setOpen2(true);
        status = true;
      }
       ...
       if (
        ...
        setErrorMessage(
          "Reviewer Start Date hould be a date after Calendar Start Date."
        );
        setOpen2(true);
        status = true;
      }
  ...
  return (
    <>
      <PAMaster name={from +" Calendar"} nav={`${CALENDER_VIEWPAGE}`}  secondName={"Calendar Setting"}/>
      ...
      >
        ...
        > */}
          {/* {hideAlert && dupError && (
            <Alert style={{
              fontFamily:"Arial",
            }} severity="error">Entered Calendar already exists!</Alert>
          )}
          ...
          {hideAlert && emptyError && (
            <Alert style={{
              fontFamily:"Arial",
            }}  severity="error">Enter all Calendar text fields!</Alert>
          )}

          {showAddAlert && (
            <Alert style={{
              fontFamily:"Arial",
            }}  severity="error">Calendar name is mandatory!</Alert>
          )} */}
        ...
        <Scroll>
          <Scrollbar   style={{ width: "100%", height: "calc(100vh - 258px)" }}> 
          <Table size="small">
            <TableHead
